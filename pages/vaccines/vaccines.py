...
def display_vaccines():
    return [
        ...
        html.H2("25-34"),
        dbc.Row([
            dbc.Col(display_graphic(id='vaccines-25-34',
                                    figure=vaccine_nis5('25-34'),
                                    config=dict(locale=str(get_locale())))),
        ]),
        html.H2("18-25"),
        dbc.Row([
            dbc.Col(display_graphic(id='vaccines-18-25',
                                    figure=vaccine_nis5('18-25'),
                                    config=dict(locale=str(get_locale())))),
        ]),
        html.H2("0-17"),
        dbc.Row([
            dbc.Col(display_graphic(id='vaccines-0-17',
                                    figure=vaccine_nis5('0-17'),
                                    config=dict(locale=str(get_locale())))),
        ]),
