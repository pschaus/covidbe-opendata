...
cases_menu = AppMenu(lazy_gettext("Cases"), "/cases", [
    ...
    AppLink(get_translation(en="Cases per admin region",fr="Cas par arrondissement"), get_translation(en="Admin Region",fr="Arrondissement"), "/admin_region", display_admin),
