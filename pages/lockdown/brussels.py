...
from graphs.brussels import brussels_tunnels, brussels_tunnels_ratio, brussels_alltunnels_ratio
...
def display_brussels():
    return [
        ...
        html.H2(gettext("Brussels all tunnels relative traffic working days 7:00-8:00")),
        dbc.Row([
            dbc.Col(dcc.Graph(id='brussels-tunnel-ratio',
