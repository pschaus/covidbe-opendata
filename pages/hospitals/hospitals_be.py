...
from graphs.hopitals import bar_hospitalization, hospi_over_death_smooth,hospi_smooth,death_smooth,icu_over_hospi,newin_smooth,death_over_icu_smooth, bar_hospitalization_ICU, bar_hospitalization_tot, bar_hospitalization_in_out
