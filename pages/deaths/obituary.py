    ...
    return [
        ...
        html.Div([
            dcc.Markdown(get_translation(
                fr=""" Les données rapportées sont téléchargées des sites mortuaires belges (inmemoriam.be, necro.sudpress.be, dansnospensees.be) et français (avisdeces.fr) quotidiennement. 
