...
from pages.vaccines import vaccines_menu
...
menus = [index_menu, cases_menu, deaths_menu, hospitals_menu, vaccines_menu, who_menu, lockdown_menu, international_menu]
menu_links = {}
